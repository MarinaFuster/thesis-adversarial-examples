# In this experiment we will manipulate the first component since
# it represents 53% of the image information
# Date: 01/03/2021
...
if __name__ == '__main__':
    ...
    first_from = float(components_from[0])
    first_to   = float(components_to[0])
    step = abs((first_to - first_from))/10
    ...
    while current != NUMBER_OF_STEPS:
        ...
        with open(filename, "w") as file:
            components_from[0] = f"{first_from + step * current}\n"
